...
class TranslationView:
    ...
    def _setup_ui(self) -> None:
        ...
        self.word_label = ttk.Label(
            self.frame, text="No word selected", style="Custom.TLabel"
        )
        ...
        self.text_widget.tag_configure("bold_large", font=("Helvetica", 13, "bold"))
        self.text_widget.tag_configure("normal", font=("Helvetica", 11))
